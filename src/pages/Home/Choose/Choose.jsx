    ...
    return (
        <section className="choose">
            <div className="container">
                <h3 className="choose__title">Почему выбирают нас?</h3>

                <div className="choose__row">
                    <div className="choose__top">
                        <div className="choose__col">
                            <p className="choose__text">
                                Скидки постоянным <br/> клиентам от 5%
                            </p>
                        </div>
                        <div className="choose__col">
                            <p className="choose__text">
                                Предлагаем самые <br/> выгодные цены
                            </p>
                        </div>
                        <div className="choose__col">
                            <p className="choose__text">
                                Наши покупатели всегда <br/> остаются довольны
                            </p>
                        </div>
                        <div className="choose__col">
                            <p className="choose__text">
                                Ширикий ассортимент <br/> товаров для всей семьи
                            </p>
                        </div>
                    </div>
                    <div className="choose__btm">
                        <div className="choose__col3" >
                            <button className="choose__up">
                            ...
                            <p className="choose__text">
                                Возможность доставки в <br/> любой город Беларуси
                            </p>
                        </div>

                        <div className="choose__col2">
                            <p className="choose__text">
                                Пункты выдачи заказов <br/> рядом с домом
                            </p>
                            <button className="choose__message">
