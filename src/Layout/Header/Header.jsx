            ...
            <div className="container">
                <nav className="header__nav">
                    ...
                    <div className="header__menus">
                        <div className="header__menus-img">
                            <img src={menuCircle} alt="" className="menu__img-circle"/>
                        </div>
                        <div className="header__menus-bottom">
                            <ul className="header__menus-list">
                                <li className="header__menus-item">Женщинам</li>
                                <li className="header__menus-item">Мужчинам</li>
                                <li className="header__menus-item">Детям</li>
                                <li className="header__menus-item">Обувь</li>
                                <li className="header__menus-item">Игрушки</li>
                                <li className="header__menus-item">Аксессуары</li>
                                <li className="header__menus-item">Акции</li>
                            </ul>
                        </div>
                    </div>
